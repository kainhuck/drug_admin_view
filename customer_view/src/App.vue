...
export default {
  ...
  data: () => ({
    ...
    drawer: null,
    items: [
      { icon: 'mdi-medical-bag', text: '药品商城', src: '/shopmall' },
      { icon: 'mdi-playlist-star', text: '历史订单', src: '/saleOrder' },
      { icon: 'mdi-account-plus', text: '注册', src: '/register' }
    ]
  }),
  methods: {
    routerTo (src) {
